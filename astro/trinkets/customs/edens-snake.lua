...
if EID then
    EID:addTrinket(
        ...
        "!!! 효과가 발동된 뒤 사라집니다.#소지중인 상태에서 {{MegaSatanSmall}}Mega Satan, {{DeliriumSmall}}Delirium, {{MotherSmall}}Mother 처치 시 {{Collectible381}}Eden's Blessing 1개를 소환합니다.#Dogma 처치 시 {{Collectible381}}Eden's Blessing 1개를 획득합니다.",
        "에덴의 뱀"
    )
