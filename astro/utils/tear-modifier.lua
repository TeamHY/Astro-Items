...
function Astro:Delay2Tears(delay)
    return 30 / (delay + 1)
end

function Astro:Tears2Delay(tears)
    return (30 / tears) - 1
end

---@function
function Astro:Clamp(value, min, max)
...
---@function
function Astro:Lerp(first, second, percent)
...
---@return integer
function Astro:GetTearModifierLuck(player)
