...
Descriptions.trinkets = {
    ...
    [3] = {
        { text = "10% 확률로 빙결 눈물 발사 <color=0xFFb9d27d>(행운 비례)" },
    },
    [4] = {
        { text = "저주방 문으로부터 면역" },
        { tag = "1", text = "맵에 저주방 표시" },
    },
    [5] = {
    ...
    [10] = {
        { text = "천사방 확률 <color=0xFF3BF745>+15%" },
        { text = "저주로부터 면역" },
    },
    [11] = {
        { text = "행운 <color=0xFFF7513B>-5" },
        { text = "캐릭터 기준 2칸 이내 방들의 구조를 맵에 표시" },
        { text = "가려진 아이템을 밝힘" },
    },
    [12] = {
        { text = "<warning>일회용" },
        { text = "보물방에 천체관 아이템 1개 생성" },
    },
    [13] = {
