...
if EID then
    ...
    Astro:AddEIDCollectible(Astro.Collectible.DIVINE_LIGHT, "신의 조명", "천벌 받으리", "공격이 적에게 명중 시 10%의 확률로 빛줄기를 소환합니다.#중첩이 가능합니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 18 이상일 때 100% 확률 ({{LuckSmall}}행운 1당 +5%p)")
end
