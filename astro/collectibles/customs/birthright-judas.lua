...
if EID then
    Astro:AddEIDCollectible(Astro.Collectible.BIRTHRIGHT_JUDAS, "유다의 생득권", "충전을 힘으로!", "액티브 아이템 사용 시 충전량 한칸당 {{DamageSmall}}공격력 +1#{{ArrowGrayRight}} 최대 5까지만 증가됩니다.#중첩 시 증가량과 최대치가 증가합니다.")
end
