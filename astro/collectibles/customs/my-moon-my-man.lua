...
if EID then
    Astro:AddEIDCollectible(
        ...
        "나의 달 나의 그대",
        "...",
        "#{wakaba_md1} 버튼으로 소지중인 액티브 아이템과 카드/알약 슬롯 액티브 아이템을 교체합니다."..
        "#카드/알약 슬롯이 비어있을 경우 액티브 아이템을 그 슬롯으로 옮깁니다."..
        "#데이비드, 루시가 아니라면 교체 후 사라집니다."..
        "#캐릭터 교체 시 카드/알약 슬롯의 액티브 아이템이 사라집니다."..
        "#!!! 일부 아이템은 카드/알약 슬롯으로 옮길 수 없습니다."..
        "{{CR}}"
    )
end
