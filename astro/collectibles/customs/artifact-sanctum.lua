...
if EID then
    Astro:AddEIDCollectible(Astro.Collectible.ARTIFACT_SANCTUM, "아티팩트의 신지", "...", "스테이지를 넘어갈 때마다 소지중인 아이템 중 하나를 제거합니다.#{{ArrowGrayRight}} 제거된 아이템과 {{Collectible417}}Succubus를 소환하며, 하나를 선택하면 나머지는 사라집니다.#!!! 소지한 {{Collectible417}}Succubus가 4개 이상일 경우 이 아이템은 제거됩니다.")
end
