...
if EID then
    Astro:AddEIDCollectible(Astro.Collectible.ACUTE_SINUSITIS, "급성 부비동염", "맛있는 코딱지", "10%의 확률로 접착 눈물이 나갑니다.#중첩 시 기본 확률이 합 연산으로 증가합니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 45 이상일 때 100% 확률 ({{LuckSmall}}행운 1당 +2%p)")
end
