AstroItems.Collectible.TAURUS_EX = Isaac.GetItemIdByName("Taurus EX")
...
local effects = {
    ...
    [0] = function(player)
        for _ = 1, player:GetCollectibleNum(AstroItems.Collectible.TAURUS_EX) do
...
AstroItems:AddCallback(
    ...
    function()
        ...
        for i = 1, Game():GetNumPlayers() do
            ...
            if player:HasCollectible(AstroItems.Collectible.TAURUS_EX) then
                ...
                repeat
                    data.Taurus.Key = player:GetCollectibleRNG(AstroItems.Collectible.TAURUS_EX):RandomInt(4)
        ...
        if player:HasCollectible(AstroItems.Collectible.TAURUS_EX) then
            ...
            if data.Taurus ~= nil then
                ...
                elseif cacheFlag == CacheFlag.CACHE_FIREDELAY and data.Taurus.Key == 3 then
                    player.MaxFireDelay = AstroItems:AddTears(player.MaxFireDelay, 2 * player:GetCollectibleNum(AstroItems.Collectible.TAURUS_EX))
                end
            end
        end
    end
