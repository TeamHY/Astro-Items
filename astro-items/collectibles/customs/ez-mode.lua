...
if EID then
    AstroItems:AddEIDCollectible(AstroItems.Collectible.EZ_MODE, "쉬운 모드", "...", "후반 스테이지 진입 전까지 피격 페널티가 발생하지 않습니다.#소울 하트 1개가 증가됩니다.")
end
...
AstroItems:AddCallback(
    ...
    function(_, entity, amount, damageFlags, source, countdownFrames)
        ...
        if player ~= nil and not AstroItems:IsLatterStage() then
