...
AstroItems:AddCallback(
    ...
    function(_, isContinued)
        ...
        if EID then
            ...
            AstroItems:AddEIDCollectible(AstroItems.Collectible.VERY_EZ_MODE, "엄청 쉬운 모드", "...", "후반 스테이지 체력 제한 시스템이 6칸만 적용됩니다.#소울 하트 1개가 증가됩니다.#!!! 아래 아이템이 등장하지 않습니다.#" .. veryEZModeEIDString)
        end
    end
)
