...
AstroItems:AddCallback(
    ...
    function(_, entity, amount, damageFlags, source, countdownFrames)
        ...
        if player ~= nil then
            ...
            if (data["ssosSnakeEyeCooldown"] == nil or data["ssosSnakeEyeCooldown"] < Game():GetFrameCount()) and player:HasCollectible(AstroItems.Collectible.SINFUL_SPOILS_OF_SUBVERSION_SNAKE_EYE) and entity:IsVulnerableEnemy() then
