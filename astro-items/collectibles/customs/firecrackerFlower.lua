...
AstroItems:AddCallback(
    ...
    function(_, isContinued)
        if not isContinued then
            AstroItems.Data.FirecrackerFlower = {
                FirecrackerTears = {},
                CrackeredEnemies = {},
                PetalTears = {}
            }
...
local function FirecrackerExplode(npc, source)
    ...
    local petalTears = AstroItems.Data.FirecrackerFlower.PetalTears
...
local function AddCrackered(npc, player)
    ...
    local crackeredEnemies = AstroItems.Data.FirecrackerFlower.CrackeredEnemies
...
local function MakeTearFirecrackerSeed(tear)
    ...
    AstroItems.Data.FirecrackerFlower.FirecrackerTears[tearPtr] = true
end
...
local function OnTearCollision(_, tear, collider)
    local tearPtr = GetPtrHash(tear)
    local firecrackerTears = AstroItems.Data.FirecrackerFlower.FirecrackerTears
    local petalTears = AstroItems.Data.FirecrackerFlower.PetalTears
...
local function OnNPCUpdate(_, npc)
    ...
    if AstroItems.Data.FirecrackerFlower == nil then return end
...
local function OnEntityRemove(_, entity)
    if AstroItems:isLeavingRoom() then return end
